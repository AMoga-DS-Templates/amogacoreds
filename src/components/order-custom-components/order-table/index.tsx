...
export function OrderRecords({ records = [], title = 'Order', description = 'View and filter order records.', headerLabel, headerValue, headerAvatar, onClose }: OrderRecordsProps) {
