 ...
 */
export function convertLegacyToOoxml(data: Uint8Array, format: string): Uint8Array;
 ...
 */
export function extractLegacyPlainText(data: Uint8Array, format: string): string;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly convertLegacyToOoxml: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly extractLegacyPlainText: (a: number, b: number, c: number, d: number, e: number) => void;
